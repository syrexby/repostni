...
<div class="competition-list">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation"><a href="<?= Url::to(['competition/list']);?>">Топ популярных</a></li>
        <li role="presentation"><a href="<?= Url::to(['competition/new']);?>">Топ новых</a></li>
        <li role="presentation" class="active"><a href="<?= Url::to(['competition/finish']);?>">Завершающиеся</a></li>
    </ul>
